...
#define AI_NETWORK_MODEL_SIGNATURE     "afa4fe15bd6de6db91f6e87bb9aaef1f"
...
#define AI_TOOLS_DATE_TIME   "Thu Oct  1 15:06:07 2020"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 784, 256, 1, 1), AI_STRIDE_INIT(4, 1, 784, 200704, 200704),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    dense_2_output_array.data = AI_PTR(activations + 1024);
    dense_2_output_array.data_start = AI_PTR(activations + 1024);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_3_bias_array.data = AI_PTR(weights + 242176);
    dense_3_bias_array.data_start = AI_PTR(weights + 242176);
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(weights + 237056);
    dense_3_weights_array.data_start = AI_PTR(weights + 237056);
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(weights + 236544);
    dense_2_bias_array.data_start = AI_PTR(weights + 236544);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(weights + 203776);
    dense_2_weights_array.data_start = AI_PTR(weights + 202752);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights + 201728);
    dense_1_bias_array.data_start = AI_PTR(weights + 201728);
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(weights + 1024);
