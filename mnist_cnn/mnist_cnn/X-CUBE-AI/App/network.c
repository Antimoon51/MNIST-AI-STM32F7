...
#define AI_NETWORK_MODEL_SIGNATURE     "7cff326e313e6367881965edf797c64d"
...
#define AI_TOOLS_DATE_TIME   "Mon Oct  5 09:55:07 2020"
...
AI_STATIC ai_array features_bias_array;   /* Array #6 */
AI_STATIC ai_array features_weights_array;   /* Array #7 */
...
AI_STATIC ai_array features_output_array;   /* Array #15 */
AI_STATIC ai_array features_nl_output_array;   /* Array #16 */
...
AI_STATIC ai_tensor features_bias;   /* Tensor #6 */
AI_STATIC ai_tensor features_weights;   /* Tensor #7 */
...
AI_STATIC ai_tensor features_output;   /* Tensor #16 */
AI_STATIC ai_tensor features_nl_output;   /* Tensor #17 */
...
AI_STATIC_CONST ai_tensor_chain features_chain;   /* Chain #2 */
AI_STATIC_CONST ai_tensor_chain features_nl_chain;   /* Chain #3 */
...
AI_STATIC ai_layer_dense features_layer; /* Layer #2 */
AI_STATIC ai_layer_nl features_nl_layer; /* Layer #3 */
...
/* Array#6 */
AI_ARRAY_OBJ_DECLARE(
  features_bias_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 128, AI_STATIC)

/* Array#7 */
AI_ARRAY_OBJ_DECLARE(
  features_weights_array, AI_ARRAY_FORMAT_LUT8_FLOAT,
...
/* Array#15 */
AI_ARRAY_OBJ_DECLARE(
  features_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 128, AI_STATIC)

/* Array#16 */
AI_ARRAY_OBJ_DECLARE(
  features_nl_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 128, AI_STATIC)
...
/* Tensor #6 */
AI_TENSOR_OBJ_DECLARE(
  features_bias, AI_STATIC,
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 128, 1, 1), AI_STRIDE_INIT(4, 4, 4, 512, 512),
  1, &features_bias_array, NULL)

/* Tensor #7 */
AI_TENSOR_OBJ_DECLARE(
  features_weights, AI_STATIC,
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1024, 128, 1, 1), AI_STRIDE_INIT(4, 1, 1024, 131072, 131072),
  1, &features_weights_array, NULL)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 32, 5, 5, 64), AI_STRIDE_INIT(4, 4, 128, 640, 3200),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 5, 5, 32), AI_STRIDE_INIT(4, 4, 4, 20, 100),
...
/* Tensor #17 */
AI_TENSOR_OBJ_DECLARE(
  features_nl_output, AI_STATIC,
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 128, 1, 1), AI_STRIDE_INIT(4, 4, 4, 512, 512),
  1, &features_nl_output_array, NULL)
...
AI_LAYER_OBJ_DECLARE(
  ...
  OPTIMIZED_CONV2D_TYPE,
  conv2d_nl_pool, forward_conv2d_nl_pool,
  &AI_NET_OBJ_INSTANCE, &features_layer, AI_STATIC,
...
AI_LAYER_OBJ_DECLARE(
  ...
  DENSE_TYPE,
  dense, forward_dense,
  &AI_NET_OBJ_INSTANCE, &features_nl_layer, AI_STATIC,
  .tensors = &features_chain, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  features_nl_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &features_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &features_nl_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    conv2d_2_output_array.data = AI_PTR(activations + 6144);
    conv2d_2_output_array.data_start = AI_PTR(activations + 6144);
    conv2d_3_output_array.data = AI_PTR(activations + 4864);
    conv2d_3_output_array.data_start = AI_PTR(activations + 4864);
    features_output_array.data = AI_PTR(activations + 0);
    features_output_array.data_start = AI_PTR(activations + 0);
    features_nl_output_array.data = AI_PTR(activations + 512);
    features_nl_output_array.data_start = AI_PTR(activations + 512);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_3_bias_array.data = AI_PTR(weights + 353024);
    dense_3_bias_array.data_start = AI_PTR(weights + 353024);
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(weights + 350464);
    dense_3_weights_array.data_start = AI_PTR(weights + 350464);
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(weights + 350208);
    dense_2_bias_array.data_start = AI_PTR(weights + 350208);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(weights + 342016);
    dense_2_weights_array.data_start = AI_PTR(weights + 340992);
    features_bias_array.format |= AI_FMT_FLAG_CONST;
    features_bias_array.data = AI_PTR(weights + 340480);
    features_bias_array.data_start = AI_PTR(weights + 340480);
    features_weights_array.format |= AI_FMT_FLAG_CONST;
    features_weights_array.data = AI_PTR(weights + 209408);
    features_weights_array.data_start = AI_PTR(weights + 208384);
    conv2d_3_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_bias_array.data = AI_PTR(weights + 208128);
    conv2d_3_bias_array.data_start = AI_PTR(weights + 208128);
    conv2d_3_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_weights_array.data = AI_PTR(weights + 3328);
    conv2d_3_weights_array.data_start = AI_PTR(weights + 3328);
    conv2d_2_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_bias_array.data = AI_PTR(weights + 3200);
    conv2d_2_bias_array.data_start = AI_PTR(weights + 3200);
